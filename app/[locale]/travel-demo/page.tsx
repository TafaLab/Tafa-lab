...
export default async function TravelDemo({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const images = ["/images/stk-lab/travel/travel-website-hero.webp", "/images/stk-lab/travel/travel-digital-concierge.webp", "/images/stk-lab/travel/travel-itinerary.webp", "/images/stk-lab/travel/travel-trip-builder.webp", "/images/stk-lab/travel/travel-bookings-operations.webp", "/images/stk-lab/travel/travel-crm-dashboard.webp"];
