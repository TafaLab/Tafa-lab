...
const copy = {
  en: {
    ...
    portfolio:[
      ["STK Travel","Travel guide platform with destination guides, practical articles and consultation flow.","/images/stk-lab/travel/travel-website-hero-v2.webp","Live project","stk-travel-demo"],
  ...
  ru: {
    ...
    portfolio:[
      ["STK Travel","Travel-платформа с гайдами по направлениям, полезными статьями и консультациями.","/images/stk-lab/travel/travel-website-hero-v2.webp","Живой проект","stk-travel-demo"],
