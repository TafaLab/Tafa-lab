...
const copy = {
  en: {
    ...
    portfolioText:"This is the main STK Lab travel collection. Open either of the two available projects below: a destination guide platform and a premium travel agency demo.",
    portfolio:[
      ...
      ["Velaria Travel","Premium bespoke travel agency demo with curated journeys and digital concierge.","/images/stk-lab/travel/travel-digital-concierge.webp","Open demo","travel-demo"],
    ],
  ...
  ru: {
    ...
    portfolioText:"Это общая витрина travel-направления STK Lab. Ниже находятся два отдельных доступных проекта: платформа с гайдами по направлениям и премиальный демо-сайт турагентства.",
    portfolio:[
      ...
      ["Velaria Travel","Премиальный демо-сайт агентства индивидуальных путешествий с маршрутами и digital concierge.","/images/stk-lab/travel/travel-digital-concierge.webp","Открыть демо","travel-demo"],
    ],
