...
const copy = {
  en: {
    ...
    portfolio:[
      ...
      ["Altitude Expeditions","Extreme and sports expedition website featuring the Himalayas, Amazon, Patagonia and Arctic journeys.","/images/stk-lab/travel/demos/summit-hero.png","Open demo","expedition-demo"],
      ["Milewise Academy","Travel hacking education platform covering fares, miles, loyalty programs and complex itineraries.","/images/stk-lab/travel/demos/travel-hacking-hero.png","Open demo","travel-hacking-demo"],
    ],
  ...
  ru: {
    ...
    portfolio:[
      ...
      ["Altitude Expeditions","Сайт экстремальных и спортивных экспедиций: Гималаи, Амазония, Патагония и Арктика.","/images/stk-lab/travel/demos/summit-hero.png","Открыть демо","expedition-demo"],
      ["Milewise Academy","Образовательная платформа по travel hacking: тарифы, мили, бонусные программы и сложные маршруты.","/images/stk-lab/travel/demos/travel-hacking-hero.png","Открыть демо","travel-hacking-demo"],
    ],
