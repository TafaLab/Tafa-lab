...
const copy = {
  en: {
    ...
    portfolioText:"This is the main Tafa Lab travel collection: a destination platform, a bespoke agency, an extreme expedition company and a travel hacking academy.",
    portfolio:[
  ...
  ru: {
    ...
    portfolioText:"Это общая витрина travel-направления Tafa Lab: платформа направлений, агентство индивидуальных путешествий, компания экстремальных экспедиций и школа travel hacking.",
    portfolio:[
