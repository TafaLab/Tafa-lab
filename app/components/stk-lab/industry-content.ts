...
export const industryContent: Record<StkLabLocale, Record<IndustrySlug, IndustryPageContent>> = {
  en: {
    bakeries: {
      ...
      metaTitle: "Bakery Website Design & Cake Configurators | STK Lab",
      ...
      projectsText: "Selected bakery and cake-studio concepts, storefronts and product experiences created by STK Lab.",
      projects: [
      ...
      ctaButton: "Discuss a bakery project", back: "Back to STK Lab", viewProject: "View project",
    },
    restaurants: {
      ...
      metaTitle: "Restaurant & Café Website Design | STK Lab", metaDescription: "Custom restaurant websites, digital menus, reservations and hospitality web experiences designed by STK Lab.",
      ...
      ctaTitle: "Building a stronger restaurant presence?", ctaText: "We create restaurant websites that are easy to discover, easy to navigate and easy to book.", ctaButton: "Discuss a restaurant project", back: "Back to STK Lab", viewProject: "View project",
    },
    beauty: {
      ...
      metaTitle: "Beauty Salon & Wellness Website Design | STK Lab", metaDescription: "Premium beauty, salon and wellness websites with service presentation, booking flows and custom design.",
      ...
      ctaTitle: "Ready to elevate your beauty brand online?", ctaText: "We can turn your services and visual identity into a premium booking experience.", ctaButton: "Discuss a beauty project", back: "Back to STK Lab", viewProject: "View project",
    },
    travel: {
      ...
      metaTitle: "Travel & Hospitality Web Development | STK Lab", metaDescription: "Custom travel platforms, destination guides and hospitality websites designed and developed by STK Lab.",
      ...
      ctaTitle: "Planning a travel or hospitality platform?", ctaText: "We can design the content architecture and build the product around how travelers actually search and plan.", ctaButton: "Discuss a travel project", back: "Back to STK Lab", viewProject: "View project",
    },
    "business-platforms": {
      ...
      metaTitle: "Custom Business Platforms & Web Apps | STK Lab", metaDescription: "Custom dashboards, internal tools, admin panels and multi-location business platforms designed and developed by STK Lab.",
      ...
      ctaTitle: "Have a process that has outgrown spreadsheets?", ctaText: "We can map the workflow and build a focused internal platform around it.", ctaButton: "Discuss a custom platform", back: "Back to STK Lab", viewProject: "View project",
    },
  },
  ru: {
    bakeries: {
      ...
      metaTitle: "Сайты для кондитерских и конструкторы тортов | STK Lab", metaDescription: "Разработка сайтов для кондитерских, визуальных конструкторов тортов, онлайн-заказов и админ-панелей.",
      ...
      projectsTitle: "Работы для кондитерских", projectsText: "Избранные сайты, концепции и продуктовые решения STK Lab для кондитерских и студий тортов.",
      projects: [
      ...
      ctaTitle: "Планируете сайт кондитерской или конструктор тортов?", ctaText: "Мы можем создать и клиентский сайт, и инструменты, с которыми команда будет управлять товарами и заказами.", ctaButton: "Обсудить проект кондитерской", back: "Вернуться в STK Lab", viewProject: "Открыть проект",
    },
    restaurants: {
      eyebrow: "Рестораны и кафе", title: "Сайты ресторанов, которые превращают атмосферу в бронирования.", description: "Сайты, меню, бронирование и цифровые решения для ресторанов, кафе и hospitality-брендов.", metaTitle: "Разработка сайтов для ресторанов и кафе | STK Lab", metaDescription: "Индивидуальные сайты ресторанов, цифровые меню, бронирование и hospitality-решения от STK Lab.",
      ...
      capabilitiesTitle: "Что мы можем сделать для ресторана", capabilities: ["Сайты ресторанов и кафе", "Цифровые меню", "Онлайн-бронирование", "Сайты для нескольких филиалов", "События и private dining", "Интеграции доставки и заказов", "Админ-панели", "Локальная SEO-основа"], ctaTitle: "Хотите усилить онлайн-присутствие ресторана?", ctaText: "Создадим сайт, который легко найти, удобно посмотреть и просто забронировать.", ctaButton: "Обсудить сайт ресторана", back: "Вернуться в STK Lab", viewProject: "Открыть проект",
    },
    beauty: {
      eyebrow: "Красота и wellness", title: "Премиальные beauty-сайты с простым путем к записи.", description: "Элегантные сайты и системы записи для салонов, студий, клиник и wellness-брендов.", metaTitle: "Сайты для салонов красоты и wellness | STK Lab", metaDescription: "Премиальные сайты для beauty и wellness с услугами, онлайн-записью и индивидуальным дизайном.", introTitle: "Доверие, ясность и ощущение заботы.", introText: "В beauty-сфере решение часто принимается визуально. Мы структурируем услуги, экспертизу, результаты и запись так, чтобы сайт ощущался премиально и оставался понятным.", projectsTitle: "Работы в beauty", projectsText: "Избранные цифровые решения для красоты и wellness.", projects: [{ name: "Lumière Beauty Studio", type: "Премиальная beauty-студия", text: "Элегантный сайт с редакционной эстетикой, понятной презентацией услуг и простым сценарием бронирования.", tags: ["Beauty", "Бронирование", "Luxury", "Wellness"], status: "Избранная концепция" }], capabilitiesTitle: "Что мы можем сделать для beauty-бренда", capabilities: ["Сайты салонов и студий", "Каталоги услуг", "Онлайн-запись", "Профили специалистов", "Галереи до/после", "Подарочные карты и продажи", "CRM-интеграции", "Локальная SEO-основа"], ctaTitle: "Готовы поднять beauty-бренд на новый уровень?", ctaText: "Превратим услуги и визуальную идентичность в премиальный опыт онлайн-записи.", ctaButton: "Обсудить beauty-проект", back: "Вернуться в STK Lab", viewProject: "Открыть проект",
    },
    travel: {
      eyebrow: "Путешествия и hospitality", title: "Travel-платформы для поиска, планирования и уверенного выбора.", description: "Путеводители, hospitality-сайты и масштабируемые travel-платформы.", metaTitle: "Разработка travel и hospitality сайтов | STK Lab", metaDescription: "Travel-платформы, путеводители и сайты hospitality-брендов от STK Lab.", introTitle: "Много полезной информации — без информационного шума.", introText: "Travel-продукты содержат большой объём контента. Мы проектируем понятную архитектуру, поиск направлений и масштабируемую систему публикаций.", projectsTitle: "Работы в travel", projectsText: "Избранные проекты для путешествий и туристических направлений.", projects: [{ name: "STK Travel", type: "Платформа-путеводитель", text: "Масштабируемая платформа с гайдами по странам и городам, практической информацией и локальными рекомендациями.", tags: ["Travel", "Путеводители", "Контент-платформа", "UX/UI"], status: "Избранный проект" }], capabilitiesTitle: "Что мы можем сделать для travel", capabilities: ["Платформы направлений", "Сайты отелей и hospitality", "Гайды по городам и странам", "Поиск и фильтры", "Интеграции бронирования", "Редакционная CMS", "Мультиязычный контент", "SEO-архитектура направлений"], ctaTitle: "Планируете travel или hospitality-платформу?", ctaText: "Спроектируем архитектуру контента и продукт вокруг того, как путешественники реально ищут и планируют.", ctaButton: "Обсудить travel-проект", back: "Вернуться в STK Lab", viewProject: "Открыть проект",
    },
    "business-platforms": {
      eyebrow: "Бизнес-платформы", title: "Индивидуальные веб-системы под реальные рабочие процессы.", description: "Дашборды, внутренние инструменты, системы для нескольких филиалов и собственные админ-платформы.", metaTitle: "Бизнес-платформы и веб-приложения | STK Lab", metaDescription: "Индивидуальные дашборды, внутренние системы, админ-панели и multi-location платформы от STK Lab.", introTitle: "Когда обычного сайта уже недостаточно.", introText: "Мы превращаем таблицы, разрозненные сервисы и повторяющуюся ручную работу в единое веб-приложение, построенное вокруг реальных процессов компании.", projectsTitle: "Работы с платформами", projectsText: "Избранные внутренние системы и операционные веб-приложения.", projects: [{ name: "People's Potatoes", type: "Платформа управления рестораном", text: "Система для сети филиалов с продажами, складом, закупками, расписанием, зарплатой, поддержкой и бизнес-аналитикой.", tags: ["Дашборд", "Склад", "Зарплата", "Филиалы"], status: "Индивидуальная платформа" }], capabilitiesTitle: "Что мы можем сделать", capabilities: ["Бизнес-дашборды", "Склад и закупки", "Управление филиалами", "Расписание и посещаемость", "Расчёт зарплаты", "Роли и личные кабинеты", "Админ-панели", "Отчёты и аналитика"], ctaTitle: "Ваш бизнес уже перерос таблицы?", ctaText: "Разберём процесс и создадим сфокусированную внутреннюю платформу под него.", ctaButton: "Обсудить платформу", back: "Вернуться в STK Lab", viewProject: "Открыть проект",
    },
  },
};
