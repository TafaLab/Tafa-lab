...
const copy = {
  en: {
    ...
    services: [
      ...
      ["Online Store", "$2000", "A complete online ordering experience with a product catalogue, shopping cart, checkout, payment and delivery options."],
    ...
    projects: [
      ...
      ["Veloura Cakes", "Luxury cake studio with visual cake customization", "/images/stk-lab/bakery/veloura-cakes.webp", "Live project", "veloura-cakes-demo", ""],
      ["Maison Levain", "Artisan European bakery with online pre-order experience", "/images/stk-lab/bakery/maison-sucre.webp", "Live project", "maison-levain-demo", ""],
      ["Éclair Maison", "Luxury French pâtisserie with catalogue, ordering and delivery flow", "/images/stk-lab/bakery/bakery-online-store.webp", "Live project", "eclair-maison-demo", ""],
    ...
    packages: [
      ["Bakery Essentials", "$300", "A professional one-page website for your bakery, products and contact information."],
      ["Bakery Commerce", "$2000", "A complete online store with catalogue, cart, online ordering, payment integration and delivery options."],
  ...
  ru: {
    ...
    services: [
      ...
      ["Онлайн-магазин", "$2000", "Полноценный интернет-магазин с каталогом, корзиной, оформлением заказа, онлайн-оплатой и вариантами доставки."],
    ...
    projects: [
      ...
      ["Veloura Cakes", "Luxury cake studio с визуальной кастомизацией тортов", "/images/stk-lab/bakery/veloura-cakes.webp", "Живой проект", "veloura-cakes-demo", ""],
      ["Maison Levain", "Ремесленная европейская пекарня с онлайн-предзаказом", "/images/stk-lab/bakery/maison-sucre.webp", "Живой проект", "maison-levain-demo", ""],
      ["Éclair Maison", "Luxury pâtisserie с каталогом, заказом и доставкой", "/images/stk-lab/bakery/bakery-online-store.webp", "Живой проект", "eclair-maison-demo", ""],
    ...
    packages: [
      ["Основы для пекарни", "$300", "Профессиональный одностраничный сайт для презентации вашей пекарни, продукции и контактов."],
      ["Онлайн-продажи для пекарни", "$2000", "Полноценный интернет-магазин с каталогом, корзиной, онлайн-заказами, оплатой и вариантами доставки."],
