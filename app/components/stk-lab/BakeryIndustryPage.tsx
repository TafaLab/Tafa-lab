...
const copy = {
  en: {
    ...
    projects: [
      ...
      ["Veloura Cakes", "Luxury cake studio with visual cake customization", "/images/stk-lab/bakery/veloura-cakes.webp", "Live demo", "builder"],
      ["Maison Levain", "Artisan European bakery with online pre-order experience", "/images/stk-lab/bakery/maison-sucre.webp", "Live demo", "catalog"],
      ["Éclair Maison", "Luxury French pâtisserie with catalogue, ordering and delivery flow", "/images/stk-lab/bakery/bakery-online-store.webp", "Live demo", "gallery"],
  ...
  ru: {
    ...
    projects: [
      ...
      ["Veloura Cakes", "Luxury cake studio с визуальной кастомизацией тортов", "/images/stk-lab/bakery/veloura-cakes.webp", "Рабочее демо", "builder"],
      ["Maison Levain", "Ремесленная европейская пекарня с онлайн-предзаказом", "/images/stk-lab/bakery/maison-sucre.webp", "Рабочее демо", "catalog"],
      ["Éclair Maison", "Luxury pâtisserie с каталогом, заказом и доставкой", "/images/stk-lab/bakery/bakery-online-store.webp", "Рабочее демо", "gallery"],
