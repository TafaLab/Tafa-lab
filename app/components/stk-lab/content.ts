...
export const stkLabContent = {
  en: {
    ...
    pricing: {
      ...
      plans: [
        ["Starter", "Starter Site", "", "", "fixed scope · 1–2 weeks", ["One-page website", "Up to 7 content sections", "Responsive design", "Contact or enquiry form", "Basic SEO setup", "14 days of post-launch support"]],
        ["Studio", "Signature Website", "", "", "fixed scope · 3–5 weeks", ["Project structure and sitemap", "Up to 5 custom pages", "Custom visual design", "Contact and enquiry forms", "SEO and analytics foundations", "30 days of post-launch support"]],
        ["Atelier", "Brand & Commerce", "", "", "fixed scope · 6–10 weeks", ["Everything in Studio", "Up to 12 custom pages", "Online store or booking system", "CMS or admin panel", "Payment integrations", "60 days of post-launch support"]],
        ["Maison", "Custom Platform", "", "", "custom scope · from 3 months", ["Everything in Atelier", "Custom web application", "Business dashboards", "Product configurators", "Accounts and user permissions", "Third-party API integrations", "90 days of post-launch support"]],
      ],
    },
    ...
    faq: { eyebrow: "Frequently asked", title: "Questions, thoughtfully answered.", text: "If you have a question we haven't covered, write to us directly — we usually reply within a day.", items: [
      ...
      ["What's the investment for a premium site like the ones in your portfolio?", "Launch pricing currently starts at  for a focused one-page website,  for multi-page websites,  for commerce or booking projects, and  for custom platforms."],
  ...
  ru: {
    ...
    pricing: { eyebrow: "Инвестиции", title: "Четыре способа работать вместе.", text: "Выберите отправную точку в зависимости от масштаба и сложности проекта. Финальный объём работ подтверждается до начала разработки.", launch: "Стартовое предложение для первых пяти подтверждённых проектов", plans: [
      ["Starter", "Стартовый сайт", "", "", "фиксированный объём · 1–2 недели", ["Одностраничный сайт", "До 7 информационных блоков", "Адаптивный дизайн", "Форма заявки", "Базовая SEO-настройка", "14 дней поддержки"]],
      ["Studio", "Фирменный сайт", "", "", "фиксированный объём · 3–5 недель", ["Структура проекта и карта сайта", "До 5 индивидуальных страниц", "Уникальный визуальный дизайн", "Формы обратной связи", "SEO-основа и аналитика", "30 дней поддержки"]],
      ["Atelier", "Бренд и коммерция", "", "", "фиксированный объём · 6–10 недель", ["Всё из Studio", "До 12 индивидуальных страниц", "Интернет-магазин или бронирование", "CMS или админ-панель", "Интеграция платежей", "60 дней поддержки"]],
      ["Maison", "Индивидуальная платформа", "", "", "индивидуальный объём · от 3 месяцев", ["Всё из Atelier", "Индивидуальное веб-приложение", "Бизнес-дашборды", "Конфигураторы продуктов", "Личные кабинеты и права доступа", "Интеграции со сторонними API", "90 дней поддержки"]],
    ] },
