...
const copy = {
  en: {
    ...
    title:
      "Beauty websites that turn attention into appointments and loyal clients.",
    ...
    primary: "Explore beauty solutions",
    secondary: "Discuss a project",
    introTitle: "A beautiful brand should also be easy to book.",
    introText:
      "We connect editorial design with the practical tools a beauty business needs: clear services and pricing, frictionless booking, client management, team schedules and business analytics.",
    ...
    services: [
      ...
      [
        ...
        "Custom",
        "Appointments, client history, statuses, retention and operational workflows.",
      ],
      [
        "Staff Schedule",
        "Custom",
        "Weekly calendars, shifts, availability, breaks and appointment workload.",
      ],
      [
        "Owner Dashboard",
        "Custom",
        "Revenue, occupancy, specialists, returning clients, alerts and performance analytics.",
      ],
    ],
    bookingEyebrow: "Online Booking",
    bookingTitle: "Let clients book without messages and phone calls.",
    bookingText:
      "A branded booking flow helps clients choose a treatment, specialist, date and available time in a few clear steps.",
    catalogueEyebrow: "Services & Pricing",
    catalogueTitle: "Turn the price list into a premium digital catalogue.",
    catalogueText:
      "Services are easy to explore by category, with duration, pricing and a direct path to booking on desktop and mobile.",
    systemEyebrow: "Beauty CRM",
    systemTitle: "Manage the business behind the appointments.",
    systemText:
      "For growing studios we can build CRM, appointment management, client records, revenue analytics, team performance, inventory and reporting.",
    portfolioTitle: "Beauty websites you can explore",
    portfolioText:
      "Five distinct demo experiences: a calm spa, a refined salon, an evidence-based clinic, a creative color studio and a crafted barbershop.",
    portfolio: [
      [
        "Serena Spa & Wellness",
        "Premium wellness website with rituals, programs, gift certificates and booking.",
        "/images/stk-lab/beauty/demos/sora-spa-hero-v2.webp",
        "Open demo",
        "spa-demo",
      ],
      [
        "Muse Hair & Beauty",
        "Modern salon website with services, prices, artists, portfolio and online booking.",
        "/images/stk-lab/beauty/demos/muse-salon-hero-v2.webp",
        "Open demo",
        "beauty-salon-demo",
      ],
      [
        "Aurea Cosmetology",
        "Clinical beauty website focused on skin diagnostics, transparent protocols and specialist trust.",
        "/images/stk-lab/beauty/demos/aurea-clinic-hero-v2.webp",
        "Open demo",
        "cosmetology-demo",
      ],
      [
        "VOLT Color Studio",
        "Audacious creative salon website for vivid color, graphic cuts and editorial looks.",
        "/images/stk-lab/beauty/demos/volt-salon-hero-v2.webp",
        "Open demo",
        "color-salon-demo",
      ],
      [
        "IRONWOOD Barbershop",
        "Dark editorial barbershop with services, barber profiles, client memory and chair booking.",
        "/images/stk-lab/beauty/demos/ironwood-barbershop-hero-v1.webp",
        "Open demo",
        "ironwood-barbershop-demo",
      ],
    ],
    ...
    process: [
      [
        "01",
        "Discovery",
        "Brand, services, audience, specialists and business goals.",
      ],
      [
        "02",
        "Structure",
        "Client journey from discovery to service selection and booking.",
      ],
      [
        "03",
        "Design",
        "Premium visual direction tailored to the beauty brand.",
      ],
      [
        "04",
        "Development",
        "Responsive website, booking flow and required integrations.",
      ],
      [
        "05",
        "Launch & Growth",
        "Testing, launch and expansion into CRM or management tools.",
      ],
    ],
    ...
    faqs: [
      [
        ...
        "Yes. We can link or integrate an existing booking service, or build a custom branded flow when needed.",
      ],
      [
        "Can clients choose a specific specialist?",
        "Yes. Booking can include service, specialist, date, time, duration and other business-specific options.",
      ],
      [
        "Can the system manage staff schedules?",
        "Yes. We can build schedules, shifts, availability, breaks and appointment workload for the team.",
      ],
      [
        "Can we start with a website and add CRM later?",
        "Yes. The public website can launch first and internal management tools can be added as the business grows.",
      ],
    ],
    contactEyebrow: "Start a project",
    contactTitle:
      "Ready to give your beauty business a stronger digital experience?",
    contactText:
      "Tell us about your studio, services and how clients currently book.",
    contactCta: "Discuss on WhatsApp",
  },
  ru: {
    eyebrow: "Сайты и цифровые системы для beauty-бизнеса",
    title:
      "Beauty-сайты, которые превращают внимание в записи и постоянных клиентов.",
    ...
    primary: "Смотреть beauty-решения",
    secondary: "Обсудить проект",
    introTitle: "Красивый бренд должен быть ещё и удобным для записи.",
    introText:
      "Мы соединяем editorial-дизайн с инструментами, которые нужны beauty-бизнесу: понятные услуги и цены, быстрая запись, управление клиентами, расписание команды и бизнес-аналитика.",
    ...
    services: [
      ...
      [
        "CRM и клиенты",
        "Индивидуально",
        "Записи, история клиентов, статусы, возвратность и операционные процессы.",
      ],
      [
        "Расписание мастеров",
        "Индивидуально",
        "Недельный календарь, смены, свободные окна, перерывы и загрузка.",
      ],
      [
        "Кабинет владельца",
        "Индивидуально",
        "Выручка, загрузка, мастера, постоянные клиенты, уведомления и аналитика.",
      ],
    ],
    bookingEyebrow: "Онлайн-запись",
    bookingTitle: "Клиент записывается без переписки и звонков.",
    bookingText:
      "Фирменный сценарий записи позволяет за несколько понятных шагов выбрать процедуру, мастера, дату и свободное время.",
    catalogueEyebrow: "Услуги и цены",
    catalogueTitle: "Превратите обычный прайс в премиальный цифровой каталог.",
    catalogueText:
      "Услуги удобно изучать по категориям, видеть длительность и стоимость и сразу переходить к записи с телефона или компьютера.",
    systemEyebrow: "Beauty CRM",
    systemTitle: "Управляйте бизнесом за пределами календаря записей.",
    systemText:
      "Для растущих студий можем создать CRM, управление записями и клиентами, аналитику выручки, показатели мастеров, склад и отчётность.",
    portfolioTitle: "Beauty-сайты, которые можно открыть",
    portfolioText:
      "Пять совершенно разных демо-версий: SPA, салон, косметология, студия цвета и ремесленный барбершоп.",
    portfolio: [
      [
        "Serena Spa & Wellness",
        "Премиальный wellness-сайт с ритуалами, программами, сертификатами и записью.",
        "/images/stk-lab/beauty/demos/sora-spa-hero-v2.webp",
        "Открыть демо",
        "spa-demo",
      ],
      [
        "Muse Hair & Beauty",
        "Современный сайт салона с услугами, ценами, мастерами, работами и онлайн-записью.",
        "/images/stk-lab/beauty/demos/muse-salon-hero-v2.webp",
        "Открыть демо",
        "beauty-salon-demo",
      ],
      [
        "Aurea Cosmetology",
        "Клинический beauty-сайт с диагностикой кожи, понятными протоколами и акцентом на доверие.",
        "/images/stk-lab/beauty/demos/aurea-clinic-hero-v2.webp",
        "Открыть демо",
        "cosmetology-demo",
      ],
      [
        "VOLT Color Studio",
        "Дерзкий сайт креативного салона с ярким цветом, графичными стрижками и editorial-образами.",
        "/images/stk-lab/beauty/demos/volt-salon-hero-v2.webp",
        "Открыть демо",
        "color-salon-demo",
      ],
      [
        "IRONWOOD Barbershop",
        "Тёмный editorial-сайт барбершопа с услугами, профилями мастеров, историей клиента и записью.",
        "/images/stk-lab/beauty/demos/ironwood-barbershop-hero-v1.webp",
        "Открыть демо",
        "ironwood-barbershop-demo",
      ],
    ...
    process: [
      [
        "01",
        "Исследование",
        "Бренд, услуги, аудитория, мастера и бизнес-задачи.",
      ],
      [
        "02",
        "Структура",
        "Путь клиента от знакомства до выбора услуги и записи.",
      ],
      [
        "03",
        "Дизайн",
        "Премиальная визуальная система под характер beauty-бренда.",
      ],
      [
        "04",
        "Разработка",
        "Адаптивный сайт, booking flow и необходимые интеграции.",
      ],
      [
        "05",
        "Запуск и развитие",
        "Тестирование, запуск и дальнейшее расширение до CRM и систем управления.",
      ],
    ],
    ...
    faqs: [
      [
        "Можно подключить наш существующий сервис записи?",
        "Да. Можно связать сайт с существующим сервисом или создать собственный фирменный сценарий записи.",
      ],
      [
        "Клиент сможет выбирать конкретного мастера?",
        "Да. В запись можно включить услугу, мастера, дату, время, длительность и другие необходимые параметры.",
      ],
      [
        "Можно управлять расписанием сотрудников?",
        "Да. Можно сделать смены, рабочие часы, свободные окна, перерывы и загрузку каждого мастера.",
      ],
      [
        "Можно сначала сделать сайт, а CRM добавить позже?",
        "Да. Сначала запускаем публичный сайт, а внутренние инструменты добавляем по мере роста бизнеса.",
      ],
    ],
    contactEyebrow: "Начать проект",
    contactTitle: "Вашему beauty-бизнесу нужен более сильный цифровой опыт?",
    contactText:
      "Расскажите о студии, услугах и о том, как сейчас происходит запись клиентов.",
...
export default function BeautyIndustryPage({ locale }: { locale: Locale }) {
  ...
  const message = encodeURIComponent(
    locale === "ru"
      ? "Здравствуйте! Хочу обсудить сайт или систему для beauty-бизнеса."
      : "Hello! I'd like to discuss a website or system for a beauty business.",
  );
  return (
    <StkSiteShell>
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-20 pt-16 md:grid-cols-[1.05fr_.95fr] md:px-8 md:pb-28 md:pt-24">
        ...
        <StkReveal delay={1}>
          <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--stk-radius-card)] bg-[var(--stk-media-bg)]">
            <Image
              src="/images/stk-lab/beauty/beauty-website-hero.webp"
              alt="Premium beauty website"
              fill
              priority
      ...
      <BeautyIdeasSection locale={locale} />

      <Feature
        image="/images/stk-lab/beauty/beauty-online-booking.webp"
        eyebrow={t.bookingEyebrow}
        title={t.bookingTitle}
        text={t.bookingText}
      />
      <Feature
        image="/images/stk-lab/beauty/beauty-services-catalogue.webp"
        eyebrow={t.catalogueEyebrow}
        title={t.catalogueTitle}
        text={t.catalogueText}
        reverse
      />
      <Feature
        image="/images/stk-lab/beauty/beauty-crm-dashboard.webp"
      ...
      >
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2">
            {t.portfolio.map(([name, desc, img, status, route]) => (
              <Link
                key={name}
                href={`/${locale}/${route}`}
                target="_blank"
                className="group overflow-hidden rounded-[var(--stk-radius-card)] border border-[color:var(--stk-border)] bg-[color:var(--stk-surface-card)]"
              >
